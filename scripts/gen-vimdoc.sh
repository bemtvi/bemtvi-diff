#!/usr/bin/env bash
#
# Generate doc/bemtvi-diff.txt (the vimdoc help file) from doc/bemtvi-diff.md using
...
# Edit doc/bemtvi-diff.md, then run this.
#
...
# --- per-plugin settings -----------------------------------------------------
PROJECT="bemtvi-diff"                                          # → :help bemtvi-diff
DESCRIPTION="A Meld-style side-by-side (and 3-way) diff viewer for bemtvi"  # header tagline
# -----------------------------------------------------------------------------
