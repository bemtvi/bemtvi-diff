#!/usr/bin/env bash
#
# Generate doc/nxvim-diff.txt (the vimdoc help file) from doc/nxvim-diff.md using
...
# Edit doc/nxvim-diff.md, then run this.
#
...
# --- per-plugin settings -----------------------------------------------------
PROJECT="nxvim-diff"                                          # → :help nxvim-diff
DESCRIPTION="A Meld-style side-by-side (and 3-way) diff viewer for nxvim"  # header tagline
# -----------------------------------------------------------------------------
